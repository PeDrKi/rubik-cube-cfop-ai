...
1-look đã kiểm chứng, phủ 55/57 case OLL (43 case đã đối chiếu đúng số
thứ tự chuẩn cộng đồng, số còn lại tự sinh và tự kiểm chứng qua tìm
kiếm vét cạn); 2 case chưa giải được (OLL~2 và OLL~20) đã được chứng
minh không tồn tại thuật toán thuần (chỉ xoay mặt đơn, không dùng nước
lát/rộng) nào dưới 13 nước (bằng tìm kiếm hai chiều gặp giữa trên toàn
bộ đồ thị trạng thái khối), nên rơi về đúng bảng 2-look đã kiểm chứng
nói trên. Nâng cấp này diễn ra sau khi thu thập dữ liệu và không làm
thay đổi các kết quả báo cáo ở Mục~\ref{sec:results}, vốn phản ánh bảng
OLL 2 thuật toán sinh nói trên.
...
việc nâng cấp lên 55/57 sau đó, không ảnh hưởng tới số liệu bên dưới)
thay vì rơi
...
\begin{itemize}
  ...
  \item \textbf{Độ tin cậy liên giám khảo}: từng giám khảo riêng lẻ
    ...
    giá của một giám khảo đơn lẻ nào. \emph{Lưu ý: các số ICC này lấy
    từ bản viết khảo sát, chưa được tự tính lại độc lập từ ma trận
    đánh giá thô theo từng giám khảo trong repo này; cần xác minh lại
